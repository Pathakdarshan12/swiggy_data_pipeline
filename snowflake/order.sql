...
BEGIN
    ...
    SELECT COUNT(*) INTO :v_rows_inserted FROM TEMP_ORDERS_LOAD;
...
BEGIN
    ...
    USING (
        SELECT
            ...
            TRY_CAST(RESTAURANT_ID AS INTEGER) AS RESTAURANT_ID,
    ...
    v_rows_inserted := (SELECT COUNT(*) FROM SILVER.ORDERS_SLV WHERE BATCH_ID = :P_BATCH_ID);
